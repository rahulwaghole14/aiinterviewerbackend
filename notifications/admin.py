...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Delivery Settings", {"fields": ("priority", "channels", "status")}),
        (
            "Delivery Tracking",
            {
...
class NotificationTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Content", {"fields": ("title_template", "message_template")}),
        ("Settings", {"fields": ("priority", "channels")}),
        (
            "Timestamps",
...
class UserNotificationPreferenceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Frequency Preferences", {"fields": ("daily_digest", "weekly_summary")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
