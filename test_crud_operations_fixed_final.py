...
class CRUDTester:
    ...
    def test_hiring_agency_crud(self) -> Dict[str, Any]:
        ...
        if self.test_data.get('agency_id'):
            ...
            try:
                response = self.session.put(f"{BASE_URL}/api/hiring_agency/{self.test_data['agency_id']}/", json=update_data)
                if response.status_code == 200:
        ...
        if self.test_data.get('agency_id'):
            ...
            try:
                response = self.session.delete(f"{BASE_URL}/api/hiring_agency/{self.test_data['agency_id']}/")
                if response.status_code == 204:
        ...
        if self.test_data.get('recruiter_id'):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"✅ Recruiter detail retrieved: {recruiter_detail['full_name']}")
                else:
        ...
        if self.test_data.get('recruiter_id'):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"✅ Recruiter updated successfully: {updated_recruiter['full_name']}")
                    results["update"] = True
                else:
