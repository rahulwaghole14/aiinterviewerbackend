...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'status', 'status_display', 'channels', 'metadata',
            'created_at', 'sent_at', 'read_at', 'is_read',
            'email_sent', 'in_app_sent', 'sms_sent'
        ]
        read_only_fields = [
            'id', 'recipient', 'notification_type', 'title', 'message',
            'priority', 'status', 'channels', 'metadata', 'created_at',
            'sent_at', 'read_at', 'email_sent', 'in_app_sent', 'sms_sent'
        ]
...
class NotificationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'notification_type', 'notification_type_display',
            'title', 'priority', 'priority_display', 'created_at', 'is_read'
        ]
...
class NotificationTemplateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'title_template', 'message_template', 'channels', 'priority',
...
class UserNotificationPreferenceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'email_enabled', 'in_app_enabled', 'sms_enabled',
            'interview_notifications', 'resume_notifications', 'system_notifications',
            'daily_digest', 'weekly_summary', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
...
class NotificationFilterSerializer(serializers.Serializer):
    ...
    priority = serializers.ChoiceField(choices=NotificationPriority.choices, required=False)
    status = serializers.ChoiceField(choices=NotificationStatus.choices, required=False)
    is_read = serializers.BooleanField(required=False)
    date_from = serializers.DateField(required=False)
    date_to = serializers.DateField(required=False)
    search = serializers.CharField(required=False, help_text="Search in title and message")
...
class BulkMarkReadSerializer(serializers.Serializer):
    ...
    mark_all = serializers.BooleanField(default=False, help_text="Mark all notifications as read")
