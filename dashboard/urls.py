...
from .views import (
    DashboardDataView, DashboardSummaryView, ResumeStatsView, InterviewStatsView,
    CandidateStatsView, JobStatsView, UserActivityListView, DashboardWidgetListView,
    DashboardWidgetDetailView, WidgetSettingsView, ChartDataView, ExportDashboardDataView
)
