...
def create_domains():
    ...
    domains_data = [
        ...
        {"name": "React Frontend", "description": "React.js frontend development"},
        ...
        {"name": "Full Stack Development", "description": "Full stack web development"},
    ]

    created_domains = []
    for domain_data in domains_data:
        domain, created = Domain.objects.get_or_create(
            name=domain_data["name"], defaults=domain_data
        )
        if created:
