        ...
        if response.status_code == 200:
            ...
            for company_name, company_agencies in companies.items():
                ...
                for agency in company_agencies:
                    print(f"     * {agency['email']} ({agency['first_name']} {agency['last_name']})")
...
def test_company_user_access(company_email, password, expected_company_name):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   - Correct company ({expected_company_name}): {len(correct_company_agencies)} agencies")
            ...
            if wrong_company_agencies:
                ...
                print("✅ Company user only sees hiring agencies from their own company")
