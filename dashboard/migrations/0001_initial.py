    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "metadata",
                    models.JSONField(
                        default=dict, help_text="Additional performance data"
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="dashboard_s_metric__d39f63_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data",
                    models.JSONField(default=dict, help_text="Additional metric data"),
                ),
            ...
            options={
                "indexes": [
                    models.Index(
                        ...
                        name="dashboard_d_metric__bd06e2_idx",
                    ),
                    models.Index(
                        fields=["user", "date"], name="dashboard_d_user_id_ce6d5b_idx"
                    ),
                    models.Index(
                        fields=["company_name", "date"],
                        name="dashboard_d_company_8875e5_idx",
                    ),
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position",
                    models.IntegerField(
                        default=0, help_text="Widget position on dashboard"
                    ),
                ),
                ...
                (
                    "settings",
                    models.JSONField(
                        default=dict, help_text="Widget-specific settings"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "details",
                    models.JSONField(default=dict, help_text="Activity details"),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="dashboard_u_user_id_feee39_idx",
                    ),
                    models.Index(
                        fields=["activity_type", "created_at"],
                        name="dashboard_u_activit_5ca3c8_idx",
                    ),
                ],
            },
        ),
