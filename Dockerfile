...
COPY yolov8m.pt /app/yolov8m.pt || true # Use || true to not fail if file is missing
COPY yolov8m.onnx /app/yolov8m.onnx || true # Use || true to not fail if file is missing
