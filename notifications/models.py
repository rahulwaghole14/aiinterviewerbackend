...
class Notification(models.Model):
    ...
    channels = models.JSONField(default=list, help_text="List of channels to send notification through")
...
class NotificationTemplate(models.Model):
    ...
    notification_type = models.CharField(max_length=50, choices=NotificationType.choices)
    title_template = models.CharField(max_length=255, help_text="Template for notification title")
    message_template = models.TextField(help_text="Template for notification message")
    channels = models.JSONField(default=list, help_text="Default channels for this template")
    priority = models.CharField(max_length=20, choices=NotificationPriority.choices, default=NotificationPriority.MEDIUM)
