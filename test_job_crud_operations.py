...
def test_domain_crud(token):
    ...
    if response.status_code == 201:
        ...
        log(
            f"❌ Domain creation failed: {response.status_code} - {response.text}",
            "ERROR",
        )
        return None
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Domain list retrieval failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Domain detail retrieval failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Domain update failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Domain deletion failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 200:
        ...
        if domains:
            ...
            log(
                f"✅ Using existing active domain for job testing: ID {active_domain_id} - {domains[0]['name']}"
            )
        ...
        log(
            f"❌ Failed to get domains: {response.status_code} - {response.text}",
            "ERROR",
        )
        return None
...
def test_job_crud(token, domain_id):
    ...
    if response.status_code == 201:
        ...
        log(
            f"❌ Job creation failed: {response.status_code} - {response.text}", "ERROR"
        )
        return None
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Job list retrieval failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Job detail retrieval failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 204:
        ...
        log(
            f"❌ Job deletion failed: {response.status_code} - {response.text}", "ERROR"
        )
...
def test_job_by_domain(token, domain_id):
    ...
    if response.status_code == 201:
        ...
        log(
            f"❌ Test job creation failed: {response.status_code} - {response.text}",
            "ERROR",
        )
        return
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Jobs by domain failed: {response.status_code} - {response.text}",
            "ERROR",
        )
    ...
    if response.status_code == 204:
        ...
        log(
            f"❌ Test job cleanup failed: {response.status_code} - {response.text}",
            "ERROR",
        )
...
def test_job_titles(token):
    ...
    if response.status_code == 200:
        ...
        log(
            f"❌ Job titles retrieval failed: {response.status_code} - {response.text}",
            "ERROR",
        )
