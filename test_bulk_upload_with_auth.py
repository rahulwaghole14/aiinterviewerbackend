#!/usr/bin/env python3
"""
Test script for Bulk Resume Upload API with authentication
...
def create_test_user():
    ...
    try:
        ...
        if created:
            ...
            log("✓ Test user already exists: test_bulk_user")
        return user
...
def test_bulk_resume_upload():
    ...
    log("=" * 60)
    log("TESTING BULK RESUME UPLOAD API WITH AUTHENTICATION")
    log("=" * 60)
