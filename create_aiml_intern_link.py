"""
Generate interview link for AI/ML Intern position with custom JD
"""
import os
import django
import sys
...
def main():
    ...
    # Create interview session directly (simplified approach)
    ...
    print(f"Technical Questions: 10 (AI/ML focused)")
    print(f"Coding Questions: Will be generated next")
