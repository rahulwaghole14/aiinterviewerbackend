...
def main():
    ...
    if response.status_code == 200:
        ...
        test_endpoint(
            session, "GET", "/companies/profile/", description="Get company profile"
        )
        ...
        test_endpoint(
            session, "GET", "/jobs/domains/active/", description="Get active domains"
        )
        ...
        test_endpoint(
            session, "GET", "/notifications/", description="Get notifications"
        )
