...
const VideoPlayerWithErrorHandling = ({ videoUrl, baseURL }) => {
  ...
  const handleError = (e) => {
    ...
    setError('Video cannot be played. The file may be corrupted or in an unsupported format.');
  };
                  ...
                  try {
                    ...
                    codingQuestions.forEach(qa => {
                      ...
                      if (qa.code_submission && qa.code_submission.passed_all_tests === true) {
                        ...
                        // Check if output_log contains "all passed" or similar indicators
                        ...
                        // Also check for "all_passed" or "all tests passed" indicators
                        ...
                        {technicalQuestions.length > 0 && (
                          <>
                            ...
                            {technicalQuestions.map((qa, index) => {
                              // Use sequential numbering based on array index (1-indexed)
                              // This ensures each question gets a unique number even if order values are duplicated
                          ...
                          return (
                            <>
                              ...
                              {codingQuestions.map((qa, index) => {
                                // Use separate sequential numbering for coding questions (starting from 1)
                                // Coding questions have their own independent numbering
                                const displayNumber = index + 1;
