    ...
    def test_hiring_agency_crud(self) -> Dict[str, Any]:
        ...
        if self.test_data.get("agency_id"):
            ...
            try:
                ...
                response = self.session.put(
                    f"{BASE_URL}/api/hiring_agency/hiring_agency/{self.test_data['agency_id']}/",
                    json=update_data,
                )
                if response.status_code == 200:
        ...
        if self.test_data.get("recruiter_id"):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(
                        f"✅ Recruiter detail retrieved: {recruiter_detail['first_name']} {recruiter_detail['last_name']}"
                    )
                else:
                    print(
        ...
        if self.test_data.get("recruiter_id"):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(
                        f"✅ Recruiter updated successfully: {updated_recruiter['first_name']} {updated_recruiter['last_name']}"
                    )
                    results["update"] = True
                else:
                    print(
