...
class APITester:
    ...
    def login(self, user_type="company"):
        ...
        if response.status_code == 200:
            ...
            self.log_test("/api/auth/login/", "POST", response.status_code, error=response.text)
            return False
    ...
    def test_auth_endpoints(self):
        ...
        self.log_test("/api/auth/register/", "POST", response.status_code, response.json() if response.status_code == 201 else None)
    ...
    def test_user_management(self):
        ...
        self.log_test("/api/users/profile/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        ...
        if response.status_code == 200:
            ...
            self.log_test("/api/users/profile/", "PATCH", response.status_code, response.json() if response.status_code == 200 else None)
    ...
    def test_domain_management(self):
        ...
        self.log_test("/api/jobs/domains/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        
        # Get active domains
        response = self.session.get(f"{API_BASE}/jobs/domains/active/")
        self.log_test("/api/jobs/domains/active/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
    ...
    def test_job_management(self):
        ...
        self.log_test("/api/jobs/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        ...
        if response.status_code == 201:
            ...
            self.log_test(f"/api/jobs/{self.job_id}/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        else:
            self.log_test("/api/jobs/", "POST", response.status_code, error=response.text)
    ...
    def test_candidate_management(self):
        ...
        self.log_test("/api/candidates/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        ...
        if response.status_code == 201:
            ...
            self.log_test("/api/candidates/", "POST", response.status_code, candidate_response)
            
            # Get specific candidate
            response = self.session.get(f"{API_BASE}/candidates/{self.candidate_id}/")
            self.log_test(f"/api/candidates/{self.candidate_id}/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        else:
            self.log_test("/api/candidates/", "POST", response.status_code, error=response.text)
    ...
    def test_resume_management(self):
        ...
        self.log_test("/api/resumes/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        ...
        if self.candidate_id:
            ...
            if response.status_code == 201:
                ...
                self.log_test("/api/resumes/", "POST", response.status_code, resume_response)
            else:
                self.log_test("/api/resumes/", "POST", response.status_code, error=response.text)
    ...
    def test_interview_management(self):
        ...
        self.log_test("/api/interviews/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        ...
        if self.candidate_id and self.job_id:
            ...
            if response.status_code == 201:
                ...
                self.log_test("/api/interviews/", "POST", response.status_code, interview_response)
            else:
                self.log_test("/api/interviews/", "POST", response.status_code, error=response.text)
    ...
    def test_notifications(self):
        ...
        self.log_test("/api/notifications/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        
        # Mark notifications as read
        response = self.session.post(f"{API_BASE}/notifications/mark-read/")
        self.log_test("/api/notifications/mark-read/", "POST", response.status_code, response.json() if response.status_code == 200 else None)
    ...
    def test_dashboard(self):
        ...
        self.log_test("/api/dashboard/analytics/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        
        # Get recent activities
        response = self.session.get(f"{API_BASE}/dashboard/recent-activities/")
        self.log_test("/api/dashboard/recent-activities/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
    ...
    def test_company_management(self):
        ...
        self.log_test("/api/companies/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
        
        # Get company profile
        response = self.session.get(f"{API_BASE}/companies/profile/")
        self.log_test("/api/companies/profile/", "GET", response.status_code, response.json() if response.status_code == 200 else None)
