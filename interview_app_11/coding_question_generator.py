...
try:
    ...
    print("✅ Google Cloud Text-to-Speech imported successfully in coding_question_generator.py")
except ImportError as e:
    print(f"❌ Warning: google-cloud-texttospeech not available in coding_question_generator.py: {e}")
    texttospeech = None
except Exception as e:
    print(f"❌ Unexpected error importing google-cloud-texttospeech in coding_question_generator.py: {e}")
    texttospeech = None
